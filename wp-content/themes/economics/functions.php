...
function economics_setup() {		
	$GLOBALS['content_width'] = apply_filters( 'economics_content_width', 680 );	
 ...
 */
add_action( 'after_setup_theme', 'economics_setup_woocommerce_support' );
function economics_setup_woocommerce_support()   
{
